          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {ARTICLES.map((a) => (
              <article key={a.slug} className="group flex flex-col border border-gray-100 hover:border-gold-200 transition-colors">
                ...
                {/* Image placeholder */}
                <div className="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 overflow-hidden relative flex items-center justify-center">
                  <svg className="w-12 h-12 text-gold-400/30" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
